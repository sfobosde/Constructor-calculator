namespace WindowsFormsApp1
{
	partial class Form2
	{
		...
		private void InitializeComponent()
		{
			...
			// textBox1
			// 
			this.textBox1.Location = new System.Drawing.Point(310, 17);
			...
			this.label6.Text = "Материал основания";
			// 
			// label7
			// 
			...
			this.label7.Text = "Макс. значение диаметра вывода ЭРИ";
			// 
			// textBox2
			// 
			...
			// textBox4
			// 
			this.textBox4.Location = new System.Drawing.Point(310, 150);
			...
			// textBox5
			// 
			this.textBox5.Location = new System.Drawing.Point(310, 119);
			...
			// textBox6
			// 
			this.textBox6.Location = new System.Drawing.Point(310, 181);
			...
			// textBox7
			// 
			this.textBox7.Location = new System.Drawing.Point(310, 85);
			...
			// textBox3
			// 
			this.textBox3.Location = new System.Drawing.Point(310, 213);
			...
			this.label8.Text = "Заполните все поля с информацией о печатной плате";
			// 
			// textBox8
			// 
